...
// MQTT details
const char* broker = "139.162.214.82";

const char* topicEnergyData      = "test/energydata";
const char* topicInit      = "test/init";
const char* topicDevice1    = "test/device1";
...
void mqttCallback(char* topic, byte* payload, unsigned int len) {
  ...
  Serial.println("Message arrived from Topic " + String(topic) + " :"+String(mqtt_buffer));
}
